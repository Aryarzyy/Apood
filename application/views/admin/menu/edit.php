<div class="conatiner">
    <form id="myForm" action="<?php echo base_url().'admin/menu/edit/'.$dish['d_id'];?>" method="POST"
        ...
        <div class="form-group">
            <label class="control-label">Pilih Restaurants</label>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('name') != "") ? 'is-invalid' : '';?>" name="name" id="name"
                        placeholder="Masukan Nama Menu" value="<?php echo set_value('name', $dish['name']); ?>">
                    <span></span>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('price') != "") ? 'is-invalid' : '';?>" id="price" name="price"
                        placeholder="Masukan Harga" value="<?php echo set_value('price', $dish['price']); ?>">
                    <span></span>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <?php echo (form_error('about') != "") ? 'is-invalid' : '';?>" id="about" name="about"
                        placeholder="Tentang Makanan" value="<?php echo set_value('about', $dish['about']); ?>">
                    <span></span>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <label for="img">Gambar Menu</label>
        ...
        <button type="submit" class="btn btn-primary ml-2">Simpan edit</button>
